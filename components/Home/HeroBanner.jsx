...
const HeroBanner = () => {
	const slides = [
		{
			...
			description:
				"Winter collection is here. Don't miss the opportunity!",
			image: "/banner1.jpg",
	...
	return (
		<section className="relative overflow-hidden">
			{/* Hero Slider */}
			<div className="relative h-[600px] bg-linear-to-r from-blue-50 to-purple-50">
				...
				<div className="absolute right-0 top-0 w-1/3 h-full hidden lg:block">
					<div className="relative h-full">
						...
						<div className="absolute inset-0 bg-linear-to-l from-transparent to-white/50"></div>
					</div>
				</div>
			</div>
