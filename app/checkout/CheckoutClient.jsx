  ...
  useEffect(() => {
    ...
    const executeBkashPayment = async () => {
      try {
        ...
        toast.error("Payment verification failed", { id: "bkash-exec" });
        setProcessing(false);
      }
    };
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div className="text-left">
                    ...
                    <p className="text-sm text-gray-500 mt-1">Pay with mobile wallet</p>
                  </div>
                </div>
              </button>
            </div>
                ...
                return (
                  <div key={index} className="flex items-center gap-4 p-3 hover:bg-gray-50 rounded-lg">
                    ...
                    <div className="text-right">
                      <div className="font-medium text-gray-900">৳{itemPrice.toFixed(2)}</div>
                      <div className="text-sm text-gray-500">Qty: {item.quantity}</div>
                      <div className="font-bold text-gray-900 mt-1">৳{itemTotal.toFixed(2)}</div>
                    </div>
                  </div>
                );
              })}
        ...
        <div className="space-y-8">
          ...
          <div className="bg-blue-50 rounded-xl p-6">
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-gray-600">
                <span className="font-medium">Hours:</span> 9AM - 11PM, 7 days a week
              </p>
            </div>
          </div>
        </div>
